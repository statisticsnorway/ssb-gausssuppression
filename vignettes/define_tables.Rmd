...
names(dataset)[names(dataset) == "k_group"] = "size"
dataset$size[dataset$size == "300"] = "BIG"
dataset$size[dataset$size == "400"] = "small"
dataset$county[dataset$county == 1] = "county-1"
dataset$county[dataset$county == 5] = "county-2"
dataset$county[dataset$county == 9] = "county-3"
dataset$region[dataset$region == "I"] = "D"
dataset$region[dataset$region == "J"] = "E"
dataset$region[dataset$region == "K"] = "F"
dataset$freq[1:2] <- 2:3
...
names(d2w)[names(d2w) == "k_group"] = "size"
d2w$size[d2w$size == "300"] = "BIG"
d2w$size[d2w$size == "400"] = "small"
d2w$county[d2w$county == 1] = "county-1"
d2w$county[d2w$county == 5] = "county-2"
d2w$county[d2w$county == 9] = "county-3"
d2w$region[d2w$region == "I"] = "D"
d2w$region[d2w$region == "J"] = "E"
d2w$region[d2w$region == "K"] = "F"
d2w$other[1:2] <- 2:3
rownames(d2w) <- NULL

...
- Major update of
  ...
  - The description of
    [`SuppressKDisclosure()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/SuppressKDisclosure.md)
    is now: *Frequency table suppression for targeted attribute
    disclosure protection.*
  - New parameter `identifying` in
    [`SuppressKDisclosure()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/SuppressKDisclosure.md)
    to specify information that an intruder may already know.
  - New parameter `sensitive` in
    [`SuppressKDisclosure()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/SuppressKDisclosure.md)
    to specify information considered unacceptable to disclose.
  - Further specification of identifying–sensitive relations may be
    provided via the
    [`default_targeting()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/default_targeting.md)
    parameters `targeting_include` and `targeting_exclude`.
  - The mechanism underlying these parameters is implemented through a
    new `targeting` parameter in
    [`KDisclosurePrimary()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/KDisclosurePrimary.md)
    (see its documentation for details). The `targeting` specification
    may be generated by a function (default:
    [`default_targeting()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/default_targeting.md)),
    similar to other user-supplied functions. The parameters
    `identifying` and `sensitive` are included as explicit arguments in
    [`SuppressKDisclosure()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/SuppressKDisclosure.md),
    but are in fact arguments of
    [`default_targeting()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/default_targeting.md).
  - The default `singletonMethod` for
    [`SuppressKDisclosure()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/SuppressKDisclosure.md)
    has been updated (via
    [`PackageSpecs()`](https://statisticsnorway.github.io/ssb-gausssuppression/reference/PackageSpecs.md))
    from `"anySumNOTprimary"` to `"anySum0"`. See
